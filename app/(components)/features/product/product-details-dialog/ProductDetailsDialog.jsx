        ...
        <Dialog className={"overflow-y-scroll"}>
            <form>
                <DialogTrigger asChild>
                    <div className='absolute left-0 -bottom-full capitalize text-sm bg-secondary text-center text-white w-full py-2 transition-all duration-400 group-hover:bottom-0'>
                        quick view
                    </div>
                </DialogTrigger>
