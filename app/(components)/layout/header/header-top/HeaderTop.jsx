    ...
    <div className="pt-10 pb-5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 lg:hidden">
          ...
          <div
            className="border border-primary p-2 rounded-sm cursor-pointer transition-colors duration-300 hover:text-secondary hover:border-secondary text-accent relative"
            onClick={() => dispatch(toggleCart())}
          >
            <div className="absolute -bottom-2 -right-2 w-[20px] h-[20px] rounded-full bg-secondary text-white flex items-center justify-center text-[13px]">
              {items.length}
            </div>
